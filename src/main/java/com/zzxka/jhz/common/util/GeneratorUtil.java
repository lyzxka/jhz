package com.zzxka.jhz.common.util;
...
//         gc.setControllerName("%s");
        ...
        dsc.setUsername("myzj");
        dsc.setPassword("myzj8102");
        dsc.setUrl("jdbc:mysql://47.104.142.44:33306/posp?useUnicode=true&characterEncoding=UTF-8");
        ...
        strategy.setInclude(new String[] { "pos_acq"}); // 需要生成的表
